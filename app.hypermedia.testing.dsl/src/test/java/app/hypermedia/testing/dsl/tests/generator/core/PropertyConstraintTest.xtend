...
class PropertyConstraintTest {
    ...
    @Test
    def gatedClass_whenPropertyEqualsBoolean() {
        // given
        val model = parseHelper.parse('''
            With Class "Foo" {
                When Property "Bar" Equals true
            }
        ''')
    ...
    @Test
    def gatedClass_whenPropertyEqualsString() {
        // given
        val model = parseHelper.parse('''
            With Class "Foo" {
                When Property "Bar" Equals "John Doe"
            }
        ''')
    ...
    @Test
    def gatedClass_whenPropertyNotMatchesPattern() {
        // given
        val model = parseHelper.parse('''
            With Class "Foo" {
                When Property "Bar" Not Matching "pl$"
            }
        ''')
    ...
    @Test
    def gatedClass_whenPropertySatisfiesCustomCode() {
        // given
        val model = parseHelper.parse('''
            With Class "Foo" {
                When Property "Bar" => ```value => value > 30 && value < 40```
            }
        ''')
